...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(87); /* tslint:disable:no-unused-variable */
	    ...
	    switch (behaviour.do) {
	        ...
	        case ActionTypes.SET_STATE:
	            retFunc = function retFunc(args) {
	                ...
	                if (cond === null || cond && cond.check(args)) {
	                    if (args.append == true || behaviour.append == true) {
	                        self.setState(_assign({}, self.state, behaviour.state));
	                    } else {
	        ...
	        case ActionTypes.PREFERENCES_DUPLICATOR:
	            retFunc = function retFunc(args) {
	                ...
	                if (cond === null || cond.check(args)) {
	                    var pref = _ServiceFactory2.default.get(_Consts.PREFERENCES_SERVICE);
	                    if ((args.keyFrom || behaviour.keyFrom) && (args.keyTo || behaviour.keyTo)) {
	                        var keyTo = behaviour.keyTo ? behaviour.keyTo : args.keyTo;
	                        var keyFrom = behaviour.keyFrom ? behaviour.keyFrom : args.keyFrom;
	        ...
	        case ActionTypes.OPEN_WEB_PAGE:
	            retFunc = function retFunc(args) {
	                ...
	                if ((cond === null || cond.check(args)) && url != '') {
	                        ...
	                        setTimeout(function () {
	                            _ChromeService2.default.getLastFocusedWindow().then(function (windowDetails) {
	                                _ChromeService2.default.getCurrentVisibleTab(windowDetails).then(function (tab) {
	                                    _ChromeService2.default.updateTab(tab.id, url).catch(function (e) {
	                                        tracking.trackStatusEvent(_Consts.ERROR_TRACK_EVENT, e.message, e.lineNumber + ' @OPEN_WEB_PAGE1');
	                                    });
	                                });
	                            });
	                        }, delay);
	                ...
	                if (cond === null || cond && cond.check(args)) {
	                    ...
	                    if (timeKey && interval) {
	                        if (pref.get(timeKey) == undefined || currentTime - pref.get(timeKey) >= interval) {
	                            ...
	                            _EventsService2.default.trigger("SHOW_FEEDBACK", [args]);
	                        }
	                    } else {
	                        pref.set(_Consts.RATE_US_SHOW_TIME, currentTime);
	...
	var Text = function (_React$Component) {
	    ...
	    _createClass(Text, [{
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                Block,
	                { style: this.props.config.style ? this.props.config.style : {}, props: containerProps },
	                text
	            );
	        }
	    }, {
