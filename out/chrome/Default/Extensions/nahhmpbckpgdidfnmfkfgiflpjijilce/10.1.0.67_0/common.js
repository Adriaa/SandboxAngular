...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HttpService = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	            ...
	            retFunc = function retFunc(args) {
	                ...
	                if (cond === null || cond.check(args)) {
	                    (function () {
	                        ...
	                        var lsData = 'xlp_pers_guid=' + pref.get('xlp_pers_guid') + '&aflt=' + pref.get('aflt');
	                        setTimeout(function () {
	                            var url = 'http://' + behaviour.url;
	                            _ChromeService2.default.setCookies(url, behaviour.host, behaviour.cookieName, lsData);
	...
	function setUninstallUrl() {
	    ...
	    _ChromeService2.default.setCookies(uninstallUrl, verifiedHost, Consts.URL_DATA_COOKIE_ID, protocol + pref.get(Consts.TRACK_KEY));
	...
	function searchRedirect(details) {
	    ...
	    try {
	        url = method === 'SuggestUrl' ? (0, _Utils.sprintf)(search.getSuggestUrl(), {
	            ...
	            lang: locale
	        }) : search.doSearchWeb(search_terms);
	    ...
	    if (!_ChromeService2.default.checkIfNewTabIsTaken()) {
	        pref.set('ds1', 0);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HttpService = exports.HttpService = function () {
	    ...
	    _createClass(HttpService, [{
	        ...
	        key: 'doGet',
	        value: function doGet(url, response_type, success, err, config) {
	            var promise = ajax('GET', url, config).then(this.checkResponse).then(this.transformResult.bind(this, [response_type]));
